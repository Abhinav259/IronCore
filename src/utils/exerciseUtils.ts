...
export const getExerciseDetails = (name: string): ExerciseDetails => {
  ...
  if (n.includes('crunch') || n.includes('sit-up') || n.includes('sit up')) return { 
    ...
    image: 'https://images.unsplash.com/photo-1566241142559-40e1bfc26ebc?q=80&w=800&auto=format&fit=crop&fm=webp',
  ...
  if (n.includes('triceps pushdown') || n.includes('rope pressdown')) return { 
    ...
    image: 'https://images.unsplash.com/photo-1530822847156-5df684ec5ee1?q=80&w=800&auto=format&fit=crop&fm=webp',
  ...
  if (n.includes('barbell curl') || n.includes('ez-bar curl')) return { 
    ...
    image: 'https://images.unsplash.com/photo-1581009137042-c552e485697a?q=80&w=800&auto=format&fit=crop&fm=webp',
  ...
  if (n.includes('leg press')) return { 
    ...
    image: 'https://images.unsplash.com/photo-1591940742878-13aba4b7a35e?q=80&w=800&auto=format&fit=crop&fm=webp',
  ...
  if (n.includes('bent-over row') || n.includes('barbell row')) return { 
    ...
    image: 'https://images.unsplash.com/photo-1605296867304-46d5465a13f1?q=80&w=800&auto=format&fit=crop&fm=webp',
  ...
  if (n.includes('chest press') || n.includes('machine press') || n.includes('floor press') || n.includes('incline press')) return { 
    ...
    image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=800&auto=format&fit=crop&fm=webp',
  ...
  if (n.includes('water') || n.includes('pool') || n.includes('swim') || n.includes('aqua')) return { 
    ...
    image: 'https://images.unsplash.com/photo-1530549387634-e797ca996236?q=80&w=800&auto=format&fit=crop&fm=webp',
